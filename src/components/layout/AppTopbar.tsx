...
export function AppTopbar({
  ...
  return (
    <div className="flex items-center gap-4 px-4 h-16 shrink-0 top-0 sticky z-[40] bg-background/50 saturate-150 backdrop-blur-2xl supports-[backdrop-filter]:bg-background/20 transition-colors">
      ...
      <div className="flex items-center gap-3 shrink-0 mr-2 text-[13px] text-muted-foreground">
        <span className="hidden sm:inline-block font-bold whitespace-nowrap">{totalImages > 0 ? `${totalImages} Ảnh & Video` : ""}</span>
        <Button
          variant="ghost"
          size="icon"
